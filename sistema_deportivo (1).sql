...
(4, 'table_tennis', 'Ping Pong', 0, '2025-10-24 01:17:52'),
...
INSERT INTO `miembros_plantel` (`id`, `plantel_id`, `nombre_jugador`, `posicion`, `url_foto`, `edad`, `grado`, `numero_camiseta`, `creado_en`) VALUES
(1, 1, 'Steven Lopez', 'Mediocampista', '../../img/jugadores/68fbca6494b3f-jugadorSteven.jpg', 18, '2° B', 10, '2025-10-24 18:50:12');
...
INSERT INTO `torneos` (`id`, `deporte_id`, `temporada_id`, `nombre`, `descripcion`, `fecha_inicio`, `fecha_fin`, `ida_y_vuelta`, `tipo_torneo`, `fase_actual`, `estado_id`, `max_participantes`, `creado_por`, `creado_en`, `actualizado_en`) VALUES
(1, 5, NULL, 'Copa Salesianda', 'Torneo internacional', '2025-10-17', '2025-10-16', 0, 'liga', 'liga', 2, 16, 1, '2025-10-24 20:53:44', '2025-10-24 20:53:44');
