...
$sql_partido = "SELECT p.*,
                ...
                t.nombre AS nombre_torneo, t.tipo_torneo,
                ...
                LEFT JOIN jornadas j ON p.jornada_id = j.i
                ...
                WHERE p.id = ? AND p.torneo_id IS NOT NULL";
...
if (!$partido) {
    header("Location: $redirect_url?error=Partido no encontrado.");
    exit();
}
$url_volver = "calendario.php"; 
    ...
    <main class="admin-page"> <div class="page-header">
        ...
        <div class="partido-info-card">
            <div class="torneo-info">
                ...
                <p>
                    <?php if ($partido['tipo_torneo'] == 'bracket' && !empty($partido['nombre_fase'])): ?>
                        <i class="fas fa-trophy"></i> <?php echo htmlspecialchars($partido['nombre_fase']); ?> -
                    <?php elseif (!empty($partido['numero_jornada'])): ?>
                        <i class="fas fa-calendar-alt"></i> Jornada <?php echo $partido['numero_jornada']; ?> -
                    <?php endif; ?>
                    <i class="fas <?php echo $icono_evento; ?>"></i> <?php echo htmlspecialchars($partido['deporte']); ?>
                </p>
            </div>
